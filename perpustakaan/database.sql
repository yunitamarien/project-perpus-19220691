...
<source>
<database charset="utf8mb4" collation="utf8mb4_general_ci">perpustakaan_19220824</database>
</source>
<canvas zoom="100">
<tables>
...
<sql_create_table>CREATE TABLE `tb_peminjaman` (
  ...
  CONSTRAINT `tb_peminjaman_ibfk_10` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `tb_peminjaman_ibfk_11` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `tb_peminjaman_ibfk_12` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE,
  ...
  CONSTRAINT `tb_peminjaman_ibfk_6` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `tb_peminjaman_ibfk_7` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `tb_peminjaman_ibfk_8` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `tb_peminjaman_ibfk_9` FOREIGN KEY (`tb_koleksibuku_id`) REFERENCES `tb_koleksibuku` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci</sql_create_table>
</table>
